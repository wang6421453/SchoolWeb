...
$(function () {
	...
	KindEditor.ready(function(K) {
	 ...
	 //加载数据
	 $.post(webRoot + "/wl/school/admin/schoolPersonInfo/getSchoolPersonInfoById.ac",{id:id}, function(result){
		 if(result != null){
...
function update(){
	if(getDate()){
		$.post(webRoot + "/wl/school/admin/schoolPersonInfo/updateSchoolPersonInfo.ac",schoolPersonInfo, function(result){
			if(result == 1){
				alert("信息更新成功。");
