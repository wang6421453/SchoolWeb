...
<body>
   ...
   <div class="main" id ="main"> 
       ...
       <div class="navigation">
           <a id="businessName" href="<%=webRoot%>/custom/schoolIndexShowDetailList.jsp?businessType=${param.businessType}"></a>
...
$(function(){
	...
	//加载数据
	$.post(webRoot + "/wl/school/custom/schoolIndexShow/getSchoolIndexShowById.ac",{id:id}, function(result){
		 if(result != null){
