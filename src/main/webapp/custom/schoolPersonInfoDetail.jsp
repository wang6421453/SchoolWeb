   ...
   <div class="main" id ="main"> 
       ...
       <div >
	       <div class="navigation">
	           <a id="businessName" href="<%=webRoot%>/custom/schoolPersonInfoDetailList.jsp?businessType=${param.businessType}"></a>
	           <span id="newTitle"></span></div>
	       <div class="content" id="wl_content">
...
$(function(){
	...
	//加载数据
	$.post(webRoot + "/wl/school/custom/schoolPersonInfo/getSchoolPersonInfoById.ac",{id:id}, function(result){
		 if(result != null){
			$("#newTitle").html(result.title);
			$("#title").html(result.title + ":" + result.name);
