...
function loadData(){
	...
	$.post(webRoot + "/wl/school/custom/schoolBaseInfo/getSchoolBaseInfoList.ac", searchInfo,
			function(result) {
				...
				for(var i = 0; i < length; i++){
					...
					contentList.append("<li><a href=" + webRoot + "/custom/schoolBaseInfoDetail.jsp?id=" + lstSchoolBaseInfoVo[i].id + "&businessType=" + lstSchoolBaseInfoVo[i].businessType + " target='_blank'>" + title + "</a><em>" + time + "</em></li>");
				}
				//加载分页组建
